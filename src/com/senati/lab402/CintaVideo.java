...
public class CintaVideo extends Mediateca {
	...
	public CintaVideo(int id, String titulo, float precio, String director, String actorprincipal,
			String actorsecundario, int duracion) {
	...
	public String Protagonistas() {
		return "Director : " +  director + " Actor Principal : " + actorprincipal + " Actor Secundario : " + actorsecundario;
	 }
